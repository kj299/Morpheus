...
2. **Live load.** The app was installed into a fresh Splunk Enterprise 10.2 instance: `btool check`
   ...
   ships twenty-four searches now; the seventeen added since have not been through this step.
...
and then `morpheus:score:l4` with three more. That is fifteen of the sixteen detection searches this app
ships, so the live pass above covers the app's oldest part and almost none of its detections. Their SPL
follows
