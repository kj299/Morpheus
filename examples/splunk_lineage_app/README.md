...
2. **Live load.** The app was installed into a fresh Splunk Enterprise 10.2 instance: `btool check`
   ...
   ships thirty-seven searches now; the thirty added since have not been through this step.
...
then `morpheus:score:l4` with three more, `morpheus:score:l6` with five, `morpheus:score:l7` with five, and the chained `R-C-001` and `R-C-004`.
That is twenty-seven of the twenty-eight detection searches this app ships, so the live pass above covers
