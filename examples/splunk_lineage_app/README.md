...
2. **Live load.** The app was installed into a fresh Splunk Enterprise 10.2 instance: `btool check`
   ...
   ships thirty-six searches now; the twenty-nine added since have not been through this step.
...
then `morpheus:score:l4` with three more, `morpheus:score:l6` with five, `morpheus:score:l7` with five, and the chained `R-C-001`.
That is twenty-six of the twenty-seven detection searches this app ships, so the live pass above covers
