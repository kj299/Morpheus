...
def test_the_unproduced_count_is_pinned():
    # Five of the fourteen stanzas are configuration for producers this fork has not built. Pinned rather than
    ...
    # `TC1BindingStage` gave `binding:l1` one, and again when the TC-3 stages gave layer 3 one.
    assert len(UNPRODUCED) == 5
